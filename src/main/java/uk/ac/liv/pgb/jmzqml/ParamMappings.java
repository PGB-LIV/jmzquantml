 ...
 * Date: 09-Apr-2013
 * Author: Da Qi
 * File: uk.ac.liv.pgb.jmzqml.ParamMappings.java
 *
...
public enum ParamMappings {
    ...
    private ParamMappings(final String className, final Class clazz) {
     ...
     */
    public static ParamMappings getType(final Class clazz) {
