 ...
 * Date: 07-May-2013
 * Author: Da Qi
 * File: uk.ac.liv.pgb.jmzqml.xml.jaxb.resolver.IdentificationRefRefResolver.java
 *
...
public class IdentificationRefRefResolver extends AbstractReferenceResolver<IdentificationRef> {
     ...
     */
    public IdentificationRefRefResolver(final MzQuantMLIndexer index,
     ...
     */
    @Override
    public void updateObject(final IdentificationRef object) {
