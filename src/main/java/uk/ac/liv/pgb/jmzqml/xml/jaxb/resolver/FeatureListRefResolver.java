 ...
 * Date: 02-May-2013
 * Author: Da Qi
 * File: uk.ac.liv.pgb.jmzqml.xml.jaxb.resolver.FeatureListRefResolver.java
 *
...
public class FeatureListRefResolver extends AbstractReferenceResolver<FeatureList> {
     ...
     */
    public FeatureListRefResolver(final MzQuantMLIndexer index,
     ...
     */
    @Override
    public final void updateObject(final FeatureList object) {
