 ...
 * Date: 07-May-2013
 * Author: Da Qi
 * File: uk.ac.liv.pgb.jmzqml.xml.jaxb.resolver.ProteinGroupRefResolver.java
 *
...
public class ProteinGroupRefResolver extends AbstractReferenceResolver<ProteinGroup> {
     ...
     */
    public ProteinGroupRefResolver(final MzQuantMLIndexer index,
     ...
     */
    @Override
    public final void updateObject(final ProteinGroup object) {
