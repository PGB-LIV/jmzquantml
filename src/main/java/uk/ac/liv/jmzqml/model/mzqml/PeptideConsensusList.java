...
/**
 * The list of all peptides objects for which quantitation values are reported.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="PeptideConsensus" type="{http://psidev.info/psi/pi/mzQuantML/1.0.0-rc2}PeptideConsensusType" maxOccurs="unbounded"/>
    ...
    implements Serializable, MzQuantMLObject
{
    ...
    public List<PeptideConsensus> getPeptideConsensus() {
        if (peptideConsensus == null) {
            peptideConsensus = new ArrayList<PeptideConsensus>();
        }
