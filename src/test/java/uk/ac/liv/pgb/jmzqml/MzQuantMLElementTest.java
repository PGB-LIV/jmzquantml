...
public class MzQuantMLElementTest {
    ...
    public void testGetType_Class() {
        ...
        assertNull(MzQuantMLElement.getType(uk.ac.liv.pgb.jmzqml.ParamListMappings.class));
    }
    ...
    public void testToString() {
        ...
        String roleToString = "MzQuantMLElement{"
                ...
                + ", cached=" + "false"
                + ", clazz=" + uk.ac.liv.pgb.jmzqml.model.mzqml.Role.class
                + '}';
        ...
        String paramToString = "MzQuantMLElement{"
                ...
                + ", xpath='" + null + '\''
                + ", cached=" + "false"
                + ", clazz=" + uk.ac.liv.pgb.jmzqml.model.mzqml.Param.class
                + '}';
