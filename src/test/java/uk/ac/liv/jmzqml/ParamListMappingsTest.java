...
public class ParamListMappingsTest {
    ...
    public void testGetClazz() {
        ...
        assertEquals(uk.ac.liv.jmzqml.model.mzqml.Ratio.class, ParamListMappings.Ratio.getClazz());
    }
    ...
    public void testGetType() {
        ...
        result = ParamListMappings.getType(uk.ac.liv.jmzqml.model.mzqml.Ratio.class);
        assertEquals(expResult, result);
    }
