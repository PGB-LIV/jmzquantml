# Using the API -- Example 1: [MzQuantMLCloner](http://code.google.com/p/jmzquantml/source/browse/examples/src/main/java/uk/ac/liv/jmzquantmlexample/MzQuantMLCloner.java) #
