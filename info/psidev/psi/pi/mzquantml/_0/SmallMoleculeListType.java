...
/**
 * List of small molecules and data values about the small molecules
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="SmallMolecule" type="{http://psidev.info/psi/pi/mzQuantML/0.1}SmallMoleculeType" maxOccurs="unbounded"/>
...
public class SmallMoleculeListType {

    @XmlElement(name = "SmallMolecule", required = true)
    protected List<SmallMoleculeType> smallMolecule;
     ...
     * {@link SmallMoleculeType }
     * 
     * 
     */
    public List<SmallMoleculeType> getSmallMolecule() {
        if (smallMolecule == null) {
            smallMolecule = new ArrayList<SmallMoleculeType>();
        }
