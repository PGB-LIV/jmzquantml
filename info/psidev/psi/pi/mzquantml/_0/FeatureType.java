 ...
 * 				quantitative values are extracted from MS2 spectra e.g. in iTRAQ, then the parent MS1
 * 				Feature is reported here (once), with different quantitative values in the corresponding QuantLayer.
 * 
