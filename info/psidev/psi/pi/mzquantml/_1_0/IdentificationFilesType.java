...
/**
 * All identification files associated with this quantification analysis to be referenced elsewhere.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="IdentificationFile" type="{http://psidev.info/psi/pi/mzQuantML/1.0.0-rc1}IdentificationFileType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class IdentificationFilesType {
    ...
    protected List<IdentificationFileType> identificationFile;
     ...
     * {@link IdentificationFileType }
     * 
     * 
     */
    public List<IdentificationFileType> getIdentificationFile() {
        if (identificationFile == null) {
            identificationFile = new ArrayList<IdentificationFileType>();
        }
