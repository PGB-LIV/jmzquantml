...
/**
 * The list of all groups of proteins with conflicting evidence for which quantification values are being reported along with quantitative values about those protein groups. If quantification is done on individual proteins only, ProteinGroupsList should not be included.
 * 
