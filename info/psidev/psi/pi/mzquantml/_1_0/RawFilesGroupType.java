 ...
 *       &lt;sequence>
 *         &lt;element name="RawFile" type="{http://psidev.info/psi/pi/mzQuantML/1.0.0-rc1}RawFileType" maxOccurs="unbounded"/>
...
public class RawFilesGroupType {
    ...
    protected List<RawFileType> rawFile;
    @XmlElements({
     ...
     * 
     */
    public List<RawFileType> getRawFile() {
        if (rawFile == null) {
            rawFile = new ArrayList<RawFileType>();
        }
        return this.rawFile;
    }
