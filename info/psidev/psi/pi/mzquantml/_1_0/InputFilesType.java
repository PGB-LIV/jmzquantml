 ...
 *         &lt;element name="MethodFiles" type="{http://psidev.info/psi/pi/mzQuantML/1.0.0-rc2}MethodFilesType" maxOccurs="unbounded" minOccurs="0"/>
...
public class InputFilesType {
    ...
    protected List<MethodFilesType> methodFiles;
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the methodFiles property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getMethodFiles().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MethodFilesType }
     * 
     * 
     */
    public List<MethodFilesType> getMethodFiles() {
        if (methodFiles == null) {
            methodFiles = new ArrayList<MethodFilesType>();
        }
